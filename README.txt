...
* Compatible with WordPress 3.3.1 and higher, including 4.0.  
...
= 2.1.1 =
* Updated to be compatible with WordPress 4.0 and performed general code maintenance to improve performance.
