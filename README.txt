...
* Easy installation - Just install the plugin on a site that has and SSL certificate and it works.  
...
Install from the `Plugins\Add New` section by searching `Verve SSL` when logged in to in the administration area of a WordPress site.
