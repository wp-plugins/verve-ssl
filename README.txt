...
Verve SSL is a WordPress plugin that sets the WordPress login and Administration area to use HTTPS(SSL).  This plugin Also allows for HTTPS(SSL) while viewing your WordPress blog while logged in.  
