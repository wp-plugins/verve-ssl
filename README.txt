...
2.  PHP Code only for better compatibility - No Javascript code.  
3.  No changes to WP-Config.php required.  
4.  Compatible with WordPress 3.3.1 and higher.  
5.  Reverts back to HTTP when logged off.  
6.  Converts URLs to lowercase for better SEO.   
