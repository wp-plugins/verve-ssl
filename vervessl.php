...
wp_enqueue_script('ssladmincheck', '/wp-content/plugins/verve-ssl/js/ssladmincheck.js', '', '', true);
}
function forcessl() {
wp_enqueue_script('forcessl', '/wp-content/plugins/verve-ssl/js/forcessl.js', '', '', true);
}
